...
export const SYSTEM_COLORS: SystemColor[] = [
...
export function getSystemColorById(id: string): SystemColor {
  return SYSTEM_COLORS.find((c) => c.id === id) || { id, name: 'Unknown', hex: '#ccc' };
}
