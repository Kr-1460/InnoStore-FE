...
import { BASE_PATH_INNOSTORE, HTTP_INTERCEPTORS_INNOSTORE } from "./tokens";
import { InnoStoreBaseInterceptor } from "./utils/base-interceptor";
import { DateInterceptor } from "./utils/date-transformer";

/** Configuration options for InnoStore client */
export interface InnoStoreConfig {
    /** Base API URL */
    basePath: string;
...
/** Provides configuration for InnoStore client */
/** */
/** @example */
/** ```typescript */
/** // In your app.config.ts */
/** import { provideInnoStoreClient } from './api/providers'; */
/** */
/** export const appConfig: ApplicationConfig = { */
/**   providers: [ */
/**     provideInnoStoreClient({ */
...
/** }; */
/** ``` */
export function provideInnoStoreClient(config: InnoStoreConfig): EnvironmentProviders {
    ...
    const providers: Provider[] = [
        ...
        // Base interceptor that handles client-specific interceptors
        {
            ...
            useClass: InnoStoreBaseInterceptor,
            multi: true
        }
    ];
    ...
    if (config.interceptors && config.interceptors.length > 0) {
        ...
        providers.push({
            provide: HTTP_INTERCEPTORS_INNOSTORE,
